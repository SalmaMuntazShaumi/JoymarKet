...
public class AdminProductManagementView {
    ...
    private void showAddProductDialog() {
        ...
        addBtn.setOnAction(e -> {
            String result = controller.addNewProduct(
                nameField.getText(),
                priceField.getText(),
                stockField.getText(),
    ...
    private void showEditProductDialog(Product product) {
        ...
        updateBtn.setOnAction(e -> {
            String result = controller.editProductDetails(
        ...
        restockBtn.setOnAction(e -> {
            ...
            String result = controller.restockProduct(
                product.getIdProduct(),
                additionalStock
            );
    ...
    private void showLowStockProducts() {
        ...
        if (lowStockProducts.isEmpty()) {
            ...
            TableColumn<Product, String> idCol = new TableColumn<>("ID");
            idCol.setCellValueFactory(cellData -> 
                new javafx.beans.property.SimpleStringProperty(cellData.getValue().getIdProduct()));
            ...
            VBox layout = new VBox(10, 
                new Label("⚠️ Products with stock ≤ 10 units:"),
                lowStockTable
            );
            layout.setPadding(new Insets(20));
