...
public class ProductModel {
	...
	public static List<Product> getAllProducts() {
		...
		try (Connection conn = DBConnection.getConnection();
			...
			while (rs.next()) {
				Product product = new Product(rs.getString("idProduct"), rs.getString("name"), rs.getDouble("price"),
	...
	public static Product getProductById(String idProduct) {
		...
		try (Connection conn = DBConnection.getConnection(); PreparedStatement stmt = conn.prepareStatement(query)) {
			...
			if (rs.next()) {
				return new Product(rs.getString("idProduct"), rs.getString("name"), rs.getDouble("price"),
						rs.getInt("stock"), rs.getString("category"));
			}
		} catch (SQLException e) {
	...
	public static ProductStats getProductStatistics() {
		...
		try (Connection conn = DBConnection.getConnection()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query1); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query2); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query3); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query4); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query5); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
			...
			try (PreparedStatement stmt = conn.prepareStatement(query6); ResultSet rs = stmt.executeQuery()) {
				if (rs.next()) {
